...
######## UNCOMMENT and FILL UP all you think is necessary (following the suggested scheme) ########
    ...
    def trackObject(self, colorRangeMin=[0,0,0], colorRangeMax=[255,255,255]):
        ...
        while not finished:
            ...
            if (self.is_blob.value):
                ...
                if self.size_b.value > 190 and not triedCatch and abs(self.x_b.value - self.cols.value/2) < 50:
    ...
    def detect_scape_cv2(self, vel):
        ...
        self.setSpeed(vel, 0)
        self.check_position_3_values(center_table[0], center_table[1], np.deg2rad(90), 10,100, np.deg2rad(180))
        #self.align()
        self.align(imgs_center[0], imgs_center[1], np.deg2rad(1))
